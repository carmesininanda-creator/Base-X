...
5. **Capacidades autorizáveis (roadmap Base-X, pós-piloto).** Google Calendar já existe; as demais entram como capacidades futuras, TODAS com uma única missão: **reduzir fricção e devolver tempo, energia, segurança, presença e qualidade de vida** — especialmente para idosos e famílias. O horizonte registrado: calendário · agenda médica · exames · remédios · documentos · planejamento financeiro · transporte (ex.: Uber) · mercado/farmácia (ex.: Rappi) · casa inteligente (ex.: Alexa) · familiares e contatos de confiança · rotinas de idosos · lembretes de cuidado · organização da casa · saúde e bem-estar. Regras invioláveis: cada capacidade nasce **desligada**, é **opcional, autorizada e revogável pela pessoa**; nenhuma é prometida em conversa antes de existir; e a Giulieta **não é uma lista de apps** — ela é a interface humana da Base-X: a pessoa fala, ela entende a missão, especialistas e integrações trabalham nos bastidores, ela volta com clareza, pede autorização quando necessário e acompanha até resolver.
